package popularmovies.muhammadfarag.popularmovies;
...
public class MoviesContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        final String singleMovieQuerySelection = MoviesContract.MovieEntry.TABLE_NAME + "." + MoviesContract.MovieEntry.COLUMN_ID + " = " + MoviesContract.MovieEntry.extractMovieId(uri);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        mMoviesDatabaseHelper.getWritableDatabase().insert(MoviesContract.MovieEntry.TABLE_NAME, null, values);
        return uri;
    }

    @Override
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        return mMoviesDatabaseHelper.getWritableDatabase().delete(MoviesContract.MovieEntry.TABLE_NAME, selection, selectionArgs);
    }
