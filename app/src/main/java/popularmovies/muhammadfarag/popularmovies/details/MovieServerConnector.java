...
//        this.apikey = context.getString(R.string.server_api_key);
        ...
        this.apikey = sharedPreferences.getString("api-key", context.getString(com.muhammadfarag.popularmovies.R.string.server_api_key));
        mPath = setPath();
    }

    public String getData() throws IOException, UnauthorizedException {
        String baseUrl = this.context.getString(com.muhammadfarag.popularmovies.R.string.movie_url);
